define(["domReady!"], function () {
  ...
  var repositionParallaxyThings;

  var setUpParallaxyHandler = function () {
    if (repositionParallaxyThings) {
      window.removeEventListener("scroll", repositionParallaxyThings);
    }
    ...
    repositionParallaxyThings = (function () {
  ...
  setUpParallaxyHandler();
  window.addEventListener("resize", setUpParallaxyHandler);
});
